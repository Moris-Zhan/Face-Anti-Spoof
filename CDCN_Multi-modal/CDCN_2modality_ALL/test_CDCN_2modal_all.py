...
def train_test():
    ...
    with torch.no_grad():
        ...
        for i, sample_batched in enumerate(dataloader_val):
            ...
            text_label = f"{string_name[0]} spoof:{spoof_label} map_score:{map_score} fps={fps}"
            ...
            for t, heatmap in enumerate(FeatureMapTList):
                ...
                heatmap_RGB = cv2.putText(heatmap_RGB, text_label, (0, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
