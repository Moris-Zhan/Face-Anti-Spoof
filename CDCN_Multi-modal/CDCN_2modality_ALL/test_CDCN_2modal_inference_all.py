...
"""
test check inference time & export video
"""

def mmerge_pp(rgb, depth, map_x):
    ...
    merge_frame = np.concatenate([rgb, depth, heatmap], axis=1)
    ...
    with torch.no_grad():
        ...
        for i, sample_batched in enumerate(dataloader_val):
            ...
            for frame_t in range(inputs.shape[1]):
                ...
                merge_frame = mmerge_pp(orign_img, inputs_depth[:,frame_t,:,:,:], map_x)
        ...
        map_score_val_filename = f"./{args.log}/videos/map_score_tes.txt"
...
if __name__ == "__main__":
    ...
    # python test_CDCN_inference_all.py --thres 0.7 --log CDCN_3modality_P1_4@1 --protocol 4@1
    # python test_CDCN_inference_all.py --thres 0.7 --log CDCN_3modality_P1_4@2 --protocol 4@2
    # python test_CDCN_inference_all.py --thres 0.7 --log CDCN_3modality_P1_4@3 --protocol 4@3
