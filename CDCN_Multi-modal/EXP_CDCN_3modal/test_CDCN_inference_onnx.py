...
def train_test():
    ...
    model.load_state_dict(torch.load(f'Multi-modal/tools/mcdcn.pkl'))
    ...
    with torch.no_grad():
        ...
        for i, sample_batched in enumerate(dataloader_val):
            ...
            """Transform ONNX"""           
            ori_output_file = "Multi-modal/tools/mcdcn_ori.onnx"
            output_file = "Multi-modal/tools/mcdcn.onnx"
