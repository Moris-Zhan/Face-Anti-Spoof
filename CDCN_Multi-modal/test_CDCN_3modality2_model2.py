...
test_list = f'{image_dir}/4@1_test_res.txt'
...
def train_test():
    ...
    model.load_state_dict(torch.load('CDCN_3modality_P1/CDCN_3modality_P1_best.pkl'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="CDCN_3modality_P1", help='log and save model name')
