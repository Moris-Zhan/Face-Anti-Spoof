...
"""Prepare demo_2modal_lohi file"""
video_save_path = "./Multi-modal/tools/demo_2modal_lohi.mp4"
...
def read_modal_img(res, 
        ...
        mcdcn_file="./tools/mcdcn_2modal_lohi.onnx"):
    ...
    try:
        for dir0 in res:
            ...
            for rgb_path in rgb_paths:
                ...
                os.makedirs("./tools/demo_2modal_lohi/", exist_ok=True)
                cv2.imwrite(f"./tools/demo_2modal_lohi/{fn}.jpg", img)
                out.write(img)
