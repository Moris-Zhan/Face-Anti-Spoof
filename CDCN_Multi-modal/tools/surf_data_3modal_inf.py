...
video_save_path = "./Multi-modal/tools/demo_3modal.mp4"
    ...
    try:
        for dir0 in res:
            ...
            for rgb_path in rgb_paths:
                ...
                os.makedirs("Multi-modal/tools/demo_3modal/", exist_ok=True)
                cv2.imwrite(f"Multi-modal/tools/demo_3modal/{fn}.jpg", img)
                out.write(img)
